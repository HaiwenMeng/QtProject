...
void action()
{
  ...
  HTuple  hv_NumThreadsTraining, hv_ExampleDataDir, hv_InitialModelFileName;
  ...
  HTuple  hv_XAxisLabel, hv_DisplayParam, hv_FileExists, hv_DLModelHandle;
  HTuple  hv_DLDataset, hv_ModelType, hv_AvailableGenParam;
  HTuple  hv_IndexGenParam, hv_IndexFind, hv_IsString, hv_TrainParam;
  HTuple  hv_EvaluateBeforeTrain, hv_Indices, hv_EvaluationParam;
  ...
  HTuple  hv_EvaluationComparisonKeys, hv_ConvertToMean, hv_Index;
  HTuple  hv_FoundIndices, hv_TrainResults, hv_TrainInfos;
  HTuple  hv_EvaluationInfos;
  ...
  {
  HTuple end_val189 = (hv_GenParamName.TupleLength())-1;
  HTuple step_val189 = 1;
  for (hv_IndexGenParam=0; hv_IndexGenParam.Continue(end_val189, step_val189); hv_IndexGenParam += step_val189)
  {
  ...
  //���䶨���Ƿ�Ҫ��ѵ��ǰ���������Ĳ�����
  //** �� get_genparam_single_value (GenParamName, GenParamValue, 'evaluate_before_train', EvaluateBeforeTrain)
  hv_EvaluateBeforeTrain = HTuple();
  hv_Indices = hv_GenParamName.TupleFind("evaluate_before_train");
  if (0 != (HTuple(int((hv_Indices.TupleLength())==1)).TupleAnd(int(hv_Indices!=-1))))
  {
    hv_EvaluateBeforeTrain = HTuple(hv_GenParamValue[hv_Indices]);
  }
  else if (0 != (int((hv_Indices.TupleLength())>1)))
  {
    //Throw an error if more than one value was provided for RequestedGenParamName.
    throw HException(HTuple(HTuple("Only a single parameter dictionary or none is allowed for '")+"evaluate_before_train")+"'.");
  }
  SetDictTuple(hv_TrainParam, "evaluate_before_train", hv_EvaluateBeforeTrain);

  //*get_genparam_single_value (GenParamName, GenParamValue, 'evaluate', EvaluationParam)
  hv_EvaluationParam = HTuple();
  hv_Indices = hv_GenParamName.TupleFind("evaluate");
  if (0 != (HTuple(int((hv_Indices.TupleLength())==1)).TupleAnd(int(hv_Indices!=-1))))
  {
    hv_EvaluationParam = HTuple(hv_GenParamValue[hv_Indices]);
  }
  else if (0 != (int((hv_Indices.TupleLength())>1)))
  {
    //Throw an error if more than one value was provided for RequestedGenParamName.
    throw HException(HTuple(HTuple("Only a single parameter dictionary or none is allowed for '")+"evaluate")+"'.");
  }
  SetDictTuple(hv_TrainParam, "evaluate", hv_EvaluationParam);

  //get_genparam_single_value (GenParamName, GenParamValue, 'augment', AugmentationParam)
  hv_AugmentationParam = HTuple();
  hv_Indices = hv_GenParamName.TupleFind("augment");
  if (0 != (HTuple(int((hv_Indices.TupleLength())==1)).TupleAnd(int(hv_Indices!=-1))))
  {
    hv_AugmentationParam = HTuple(hv_GenParamValue[hv_Indices]);
  }
  else if (0 != (int((hv_Indices.TupleLength())>1)))
  {
    //Throw an error if more than one value was provided for RequestedGenParamName.
    throw HException(HTuple(HTuple("Only a single parameter dictionary or none is allowed for '")+"augment")+"'.");
  }
  ...
  //get_genparam_single_value (GenParamName, GenParamValue, 'change', ChangeStrategies)
  hv_ChangeStrategies = HTuple();
  hv_Indices = hv_GenParamName.TupleFind("change");
  if (0 != (HTuple(int((hv_Indices.TupleLength())==1)).TupleAnd(int(hv_Indices!=-1))))
  {
    hv_ChangeStrategies = HTuple(hv_GenParamValue[hv_Indices]);
  }
  else if (0 != (int((hv_Indices.TupleLength())>1)))
  {
    //Throw an error if more than one value was provided for RequestedGenParamName.
    throw HException(HTuple(HTuple("Only a single parameter dictionary or none is allowed for '")+"change")+"'.");
  }
  ...
  //get_genparam_single_value (GenParamName, GenParamValue, 'display', SetDisplayParam)
  hv_SetDisplayParam = HTuple();
  hv_Indices = hv_GenParamName.TupleFind("display");
  if (0 != (HTuple(int((hv_Indices.TupleLength())==1)).TupleAnd(int(hv_Indices!=-1))))
  {
    hv_SetDisplayParam = HTuple(hv_GenParamValue[hv_Indices]);
  }
  else if (0 != (int((hv_Indices.TupleLength())>1)))
  {
    //Throw an error if more than one value was provided for RequestedGenParamName.
    throw HException(HTuple(HTuple("Only a single parameter dictionary or none is allowed for '")+"display")+"'.");
  }
  ...
  if (0 != (int(hv_ModelType!=HTuple("ocr_detection"))))
  {
    ...
    {
    HTuple end_val360 = (hv_ConvertToMean.TupleLength())-1;
    HTuple step_val360 = 1;
    for (hv_Index=0; hv_Index.Continue(end_val360, step_val360); hv_Index += step_val360)
    {
  ...
  //
  //ѵ���ڼ�����ƽ����ʧ������������ ע�⣬���������ʾ����Ϣ���㣬��ģ��ѵ��û��Ӱ�졣
  SetDictTuple(hv_TrainParam, "num_samples_mean_loss", 1000);
  //
  // stop(...); only in hdevelop

  //ѵ��
  train_dl_model(hv_DLDataset, hv_DLModelHandle, hv_TrainParam, 0.0, &hv_TrainResults, 
